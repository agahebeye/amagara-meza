                        ...
                        t.type &&
                            ...
                            o === KEY_DELETE || o === KEY_BACKSPACE
                                ? (n = getInputSelection(s[0])).length
                                    ? (e =
                                          e.substring(0, n.start) +
                                          e.substring(n.start + n.length))
                                    : o === KEY_BACKSPACE && n.start
                                    ? (e =
                                          e.substring(0, n.start - 1) +
                                          e.substring(n.start + 1))
                                    : o === KEY_DELETE &&
                                      void 0 !== n.start &&
                                      (e =
                                          e.substring(0, n.start) +
                                ...
                                : i &&
                                  ...
                                  (e += n =
                                      o ? n.toUpperCase() : n.toLowerCase()))),
                        (i = s.attr("readonly") ? 0 : 4),
                        (o = (t = s.attr("placeholder"))
                            ? measureString(t, s) + i
                            : 0),
        ...
        ($.fn.selectize = function (c) {
            ...
            return this.each(function () {
                if (!this.selectize) {
                    ...
                    new Selectize(t, $.extend(!0, {}, u, i, c)).settings_user =
                        c;
                }
            });
        }),
        ...
        Selectize.define("auto_position", function () {
            ...
            r.positionDropdown = function () {
                var t = this.$control,
                    ...
                    i =
                        i + n + o > window.innerHeight && 0 <= s - n - o
                            ? a.top
                            : a.bottom,
                    s =
                        "fit-content" === this.$wrapper[0].style.width ||
