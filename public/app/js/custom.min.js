    ...
    $(function () {
        ...
        $(function () {
            var i = function () {
                ...
                s = $("ul.nav a")
                    .filter(function () {
                        return (
                            this.href === o || 0 === o.href.indexOf(this.href)
                        );
                    })
                    .addClass("active")
                    .parent()
        ...
        (function (e, i, o) {
            var s = '[data-perform="panel-collapse"]',
                l = '[data-perform="panel-dismiss"]';
            e(s).each(function () {
                var i = { toggle: !1 },
                    o = e(this).closest(".panel"),
...
function notify(heading, text, icon = "success") {
    $.toast({
        heading,
        text,
        icon,
