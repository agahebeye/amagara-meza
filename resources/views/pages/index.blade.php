    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    <li><a class="nav-link scrollto active" href="#hero">{{__('navigation.home') }}</a></li>
                    <li><a class="nav-link scrollto" href="#about">{{__('navigation.about')}}</a></li>
                    <li><a class="nav-link scrollto" href="#services">{{__('navigation.services')}}</a></li>
                    <li><a class="nav-link scrollto" href="#departments">{{__('navigation.departments')}}</a></li>
                    <li><a class="nav-link scrollto" href="#doctors">{{__('navigation.doctors')}}</a></li>
                    ...
                    <li><a class="nav-link scrollto" href="#contact">{{__('navigation.contact')}}</a></li>
                </ul>
                <i class="bi bi-list mobile-nav-toggle"></i>
            </nav><!-- .navbar -->

            <a href="#appointment" class="appointment-btn scrollto">{{__('navigation.appointment', ['action' => 'Choisir'])}}</a>
