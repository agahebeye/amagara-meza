                ...
                <div class="vtabs customvtab">
                    <ul class="nav tabs-vertical">
                        ...
                        <li class="tab nav-item">
                            <a data-toggle="tab" class="nav-link" href="#consultation" aria-expanded="false"> <span class="visible-xs"><i class="ti-user"></i></span> <span class="hidden-xs">Consultation</span> </a>
                        </li>
                    </ul>
